      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:23csea29shapna.m.s@gmail.com" className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition-colors">
              <Mail className="w-6 h-6" />
              <span>23csea29shapna.m.s@gmail.com</span>
            </a>
            <a href="tel:6380972007" className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition-colors">
              <Phone className="w-6 h-6" />
              <span>6380972007</span>
            </a>
            <a href="https://www.linkedin.com/in/shapna-muthukumar-3700912a2/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition-colors">
