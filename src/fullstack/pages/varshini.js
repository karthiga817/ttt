      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:varshiniprabakaran0506@gmail.com" className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition-colors">
              <Mail className="w-6 h-6" />
              <span>varshiniprabakaran0506@gmail.com</span>
            </a>
            <a href="tel:+91 9150791543" className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition-colors">
              <Phone className="w-6 h-6" />
              <span>+91 9150791543</span>
            </a>
            <a href="https://www.linkedin.com/in/varshini-prabakaran-0a503a2aa/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition-colors">
